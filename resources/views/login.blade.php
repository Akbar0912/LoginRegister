...
<body>
    ...
    <div class="bg-white-100 flex max-h-screen items-center ">
        ...
        <div class="relative w-1/2 md:block hidden bg-yellow-100">
            <img src="/assets/img/login_img.png" class="w-full object-cover filter brightness-75 max-h-screen" alt="page img">
            <img src="/assets/img/logo.png" class="absolute top-0 left-0 w-24 h-45 m-5" alt="">
        </div>

        <div class="md:w-1/2 px-5 ml-16 mr-16">
            <h2 class="text-5xl font-bold font-Poppins text-[#245953]">Masuk</h2>
            <p class="text-lg  font-semibold mt-4 text-[#399386]">Selamat datang di Food Comparator</p>
            ...
            <div class="mt-3 text-gray-500">
                <p class="text-center text-sm">Belum punya akun? <a href="#"
                        class="text-black font-bold">Daftar</a> sini</p>
            </div>
        </div>
</body>
